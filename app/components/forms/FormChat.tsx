  ...
  return (
    <div className={`w-full max-w-[60.5rem] ${className}`}>
      ...
      <form
        ...
        className="sticky bottom-8 w-full bg-[var(--background)] p-4 border rounded-[1rem]"
      >
        ...
        <div className="flex flex-col mt-1 w-full items-end">
          <button
            type="submit"
            className="button button--default w-max rounded-[1rem] self-end"
          >
